...
class CategoryList extends StatefulWidget {
  ...
  CategoryList({Key key, this.serviceLists}) : super(key: key);

  final List<ServiceGroup> serviceLists;
...
class _CategoryListState extends State<CategoryList> {
  ...
  Widget build(BuildContext context) {
    print('response : ' +  widget.serviceLists[0].getTitle());
...
//    }
    final listView = ListView.builder(
      ...
      itemCount: widget.serviceLists.length,
...
//            ),
            ServiceList(
              serviceGroup: widget.serviceLists[index],
            ),
          ],
        );
      },
