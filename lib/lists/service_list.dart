                      ...
                      actions: <Widget>[
                        FlatButton(
                            onPressed: () async {
                              fullNumber = '';
                              String apiKey =
                                  'e81512A0beAe9fcA41A5d80dc47d7024';
                              String numberPath = _user
                                  .getServiceGroups()[widget.groupIndex]
                                  .getServices()[index]
                                  .getKeyPath();
                              String availableNumbersString = (await http.get(
                              ...
                              int availableNumbers = int.parse(
                                  availableNumbersString.substring(
                                      availableNumbersString.indexOf('wa_0') +
                                          8,
                                      53));
                              double balance = double.parse(currentBalance
                                  .substring(currentBalance.indexOf(':') + 1));
                              ...
                              if (balance != null &&
                                ...
                                String id = numberResponse.substring(
                                    ...
                                    numberResponse.indexOf(':', 14));
                                String numberString = numberResponse.substring(
                                    numberResponse.indexOf(':', 14) + 1);
                                print(id);
                                print(numberString);
                                  ...
                                  new Timer.periodic(const Duration(seconds: 1),
                                    ...
                                    if (statue.contains('STATUS_OK')) {
                                      ...
                                      Firestore.instance
                                          ...
                                          .updateData({
                                        'orders': List<dynamic>.from(_user
                                            .getOrderList()
                                            .map((x) => x.toMap())),
                                        'movements': List<dynamic>.from(_user
                                            .getMovements()
                                            .map((x) => x.toMap())),
                                        'currentBalance':
                                            _user.getCurrentBalance(),
